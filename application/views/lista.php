...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-light bg-light shadow p-3 mb-5 rounded fixed-top">
            <a class="navbar-brand" href="C:\xampp\htdocs\ListaCarros\dashboard.html">Carros</a>
    ...
    <main class="container">
        ...
        <button type="button" class="btn btn-primary mt-3 botao">Buscar</button>
                        ...
                        $.ajax({
                            ...
                            success: function(data) {
                                if (data.error == 0) {
                                    ...
                                    Swal.fire(data.msg_error, 'danger');
                                }
                            },
                            error: function(data) {
